...
public class ItemRegistry {
    ...
    public static final DeferredItem<BlockItem> CALIBRATED_SCULK_SHRIENKER_ITEM = ITEMS.registerSimpleBlockItem("calibrated_sculk_shrienker", BlockRegistry.CALIBRATED_SCULK_SHRIENKER);
